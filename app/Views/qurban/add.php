                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="payerName" placeholder="Nama pemberi qurban" type="text">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="payerPhone">Telp / HP</label>
                            <input class="form-control digits-only" id="payerPhone" inputmode="numeric" placeholder="08xxxxxxxxxx" type="text">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group mb-0">
                            <label for="alamat">Alamat</label>
                            <textarea class="form-control" id="alamat" placeholder="Alamat lengkap pemberi qurban" rows="2"></textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="slaughterMode">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control digits-only" id="qurbanNumber" inputmode="numeric" placeholder="Contoh: 01" type="text">
